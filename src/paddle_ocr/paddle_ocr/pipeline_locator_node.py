...
from paddle_ocr.ocr_client import recognize_image
from paddle_ocr.result_mapper import recognition_to_sensor_msg
from paddle_ocr_msgs.msg import SensorMsg
